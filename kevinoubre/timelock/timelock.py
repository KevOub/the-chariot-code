...
formatted_time = (dt.datetime.utcnow()).strftime("%Y %m %d %H %M %S")
...
if(DEBUG and TESTING):
    ...
    current_dt = dt.datetime(2013, 5, 6, 7, 43, 25, tzinfo=TIMEZONE)
...
print("CURRENT:\t{}".format(current_dt.timestamp()))
print("EPOCH:\t{}".format(epoch_dt.timestamp()))
print("DELTA:\t{}".format((current_dt-epoch_dt).total_seconds()))
